              ...
              <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-100 dark:border-gray-800 pb-12">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                      <li>
                        <Link href="/compare" className="hover:text-brand-dark dark:hover:text-white transition-standard">
                          Compare
                        </Link>
                      </li>
                      <li>
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <li>
                        <Link href="#" className="hover:text-brand-dark dark:hover:text-white transition-standard">
                          Twitter
                        </Link>
                      </li>
                      <li>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-4">
                  ...
                  <div className="flex gap-6 text-xs text-gray-400 font-bold uppercase tracking-tighter">
                    ...
                    <Link href="/cookies" className="hover:text-brand-dark dark:hover:text-white">Cookies</Link>
                  </div>
                </div>
              </div>
            </footer>
